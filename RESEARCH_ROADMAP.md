...
| 4. RQ2 + gate calibration | H3/H4 result: twins agree, proxy tracks CPVI; gate operating point chosen | Twin and proxy analysis; calibrated gate threshold | Gate ready for RQ3b | **Analysed 30 Aug 2026 on the E3 corpus.** H4 supported on all three statistics (corrected ρ 0.269–0.275, all excluding zero; `fail` AUROC 0.906); encoder-invariant; selects `y_terminal_success` as RQ3b's target. Awaiting F2 freeze and the E7 calibration run |
