...
> the SocialJax contrast is removed, and the outcome horizon is stated explicitly. Revised again 29 August
> 2026 (DSE-047): the RQ3a comparison no longer rests on prospectivity alone, now that online auditing
> exists in the literature. The dated baselines table is `docs/rq3a_baselines.md`.
